...
class FluxTransformer2DModel(
    ...
    def forward(
        ...
        if joint_attention_kwargs is not None:
            ...
            # Extract bezier density information for BezierAdapter
            bezier_density = joint_attention_kwargs.pop("bezier_density", None)
            bezier_fields = joint_attention_kwargs.pop("bezier_fields", None)
        else:
            lora_scale = 1.0
            bezier_density = None
            bezier_fields = None
        ...
        # Add bezier information to joint_attention_kwargs for transformer blocks
        if bezier_density is not None:
            if joint_attention_kwargs is None:
                joint_attention_kwargs = {}
            joint_attention_kwargs.update({
                'bezier_density': bezier_density,
                'bezier_fields': bezier_fields
            })
